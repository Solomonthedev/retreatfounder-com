...
export function Footer({ beehiivEmbedUrl: _ }: Props) {
  ...
  return (
    <footer style={{ background: 'var(--color-ink)', color: 'var(--color-cream-200)' }}>
      <div
        className="mx-auto px-8 pt-16 pb-8"
        style={{ maxWidth: 1280 }}
      >
        {/* Top grid */}
        <div
        ...
        <div
          ...
          style={{
            borderTop: '1px solid rgba(241, 231, 209, 0.12)',
            paddingTop: 24,
            fontSize: 12,
        ...
        {links.map(({ label, href }) => (
          <li key={href} style={{ marginBottom: 10 }}>
            <Link
              ...
              style={{ fontSize: 14, color: 'var(--color-cream-200)' }}
              onMouseOver={(e) =>
